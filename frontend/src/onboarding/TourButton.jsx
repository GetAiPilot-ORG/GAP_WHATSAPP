...
export default function TourButton({ className = '', compact = false }) {
    ...
    return (
        <div ref={menuRef} className={clsx('group relative', className)} data-tour="tour-menu">
            ...
            {open ? (
                <div className="absolute left-0 sm:left-auto right-0 sm:right-0 z-[9999] mt-3 w-[280px] overflow-hidden rounded-2xl border border-[var(--fp-border)] bg-[var(--fp-card)] p-2 shadow-[0_16px_40px_rgba(0,0,0,0.12)] animate-in fade-in zoom-in-95 duration-200">
                    <button
                        type="button"
