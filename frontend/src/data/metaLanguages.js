export const META_LANGUAGES = [
  ...
  ["kk", "Kazakh", "Қазақша"],
  ["ko", "Korean", "한국어"],
  ["rw_RW", "Kinyarwanda", "Ikinyarwanda"],
  ["ky_KG", "Kyrgyz", "Кыргызча"],
  ["lo", "Lao", "ລາວ"],
  ["lv", "Latvian", "Latviešu"],
  ...
  ["zu", "Zulu", "isiZulu"],
].map(([code, label, nativeName, rtl = false]) => ({
  code,
  label,
  nativeName,
  rtl,
...
export const getMetaLanguage = (code) =>
  META_LANGUAGES.find((language) => language.code === code) ||
  META_LANGUAGES.find((language) => language.code === "en_US");
